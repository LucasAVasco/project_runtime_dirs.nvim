...
---@field project_config_subdir? string Folders with this sub-folder are project folders
...
M.default = {
    ...
    project_config_subdir = ".nvim-proj/",

    folder_is_project = function(folder, config)
        local file = folder .. "/" .. config.project_config_subdir
...
---@field current_project_configuration_directory? string Absolute path to the current project configuration directory
---@field project_config_file string Relative path to the configuration file of the current project
---@field project_config_file_abs? string Absolute path to the configuration file of the current project
---@diagnostic disable-next-line: missing-fields The fields will be fulfilled in the setup function
M.done = {}
